...
**현재 볼트에서 제공하는 Supabase는 테스트용입니다!**
실제 상용 서비스를 위해서는 자체 Supabase 프로젝트를 생성해야 합니다.

**👉 먼저 `PRODUCTION_SETUP.md` 파일을 읽고 Supabase 프로젝트를 생성하세요!**

---

## 📋 사전 준비사항
- GitHub 계정 (이미 있음 - transport-info1 저장소)
- **자체 Supabase 프로젝트** (PRODUCTION_SETUP.md 참고)
- 5분 정도의 시간
...
⚠️ **주의: 자체 Supabase 프로젝트의 키를 사용하세요!**

다음 6개의 환경 변수를 모두 추가해야 합니다:

#### 1. VITE_SUPABASE_URL
- **NAME**: `VITE_SUPABASE_URL`
- **VALUE**: 자신의 Supabase 프로젝트 URL (예: `https://xxxxx.supabase.co`)
- **"Add"** 클릭

#### 2. VITE_SUPABASE_ANON_KEY
- **NAME**: `VITE_SUPABASE_ANON_KEY`
- **VALUE**: 자신의 Supabase anon key
- **"Add"** 클릭

#### 3. SUPABASE_URL
- **NAME**: `SUPABASE_URL`
- **VALUE**: 자신의 Supabase 프로젝트 URL (1번과 동일)
- **"Add"** 클릭

#### 4. SUPABASE_ANON_KEY
- **NAME**: `SUPABASE_ANON_KEY`
- **VALUE**: 자신의 Supabase anon key (2번과 동일)
- **"Add"** 클릭

#### 5. SUPABASE_SERVICE_ROLE_KEY
- **NAME**: `SUPABASE_SERVICE_ROLE_KEY`
- **VALUE**: 자신의 Supabase service_role key
- ⚠️ **절대 공개하지 마세요!**
- **"Add"** 클릭

#### 6. SEOUL_BUS_API_KEY (선택사항)
- **NAME**: `SEOUL_BUS_API_KEY`
- **VALUE**: 서울 공공데이터 API 키 (나중에 발급 가능)
- **"Add"** 클릭

**총 6개의 환경 변수가 추가되어야 합니다!**

> 💡 Tip: Supabase 키는 프로젝트 Settings > API에서 확인 가능합니다.
